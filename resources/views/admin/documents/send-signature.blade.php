...
@section('title', 'Request TTD Digital 3 Level')
...
<div class="container mx-auto px-4 py-8 max-w-7xl">
    ...
    <nav class="mb-6 text-sm">
        <ol class="flex items-center space-x-2 text-gray-600">
            ...
            <li><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg></li>
            <li class="text-gray-900 font-semibold">Tanda Tangan</li>
        </ol>
    </nav>
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Request Tanda Tangan Digital 3 Level</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl shadow-sm border-2 border-green-200 p-5">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-green-900 mb-2">✅ Verifikasi Selesai</h3>
                        <div class="space-y-1 text-sm text-green-800">
                            <div class="flex items-center gap-2">
                                <span class="text-green-500 font-bold">✓</span>
                                <span>Level 1: Ketua Akademik</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-green-500 font-bold">✓</span>
                                <span>Level 2: Wakil Ketua 3</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-green-500 font-bold">✓</span>
                                <span>Level 3: Direktur</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="space-y-2 text-sm text-amber-800">
                            <div class="flex items-start gap-2">
                                ...
                                <span><strong>1-48 jam</strong> per level upload</span>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="text-amber-500 font-bold">•</span>
                                <span>Link berlaku <strong>7 hari</strong></span>
                            </div>
                            <div class="flex items-start gap-2">
                                <span class="text-amber-500 font-bold">•</span>
                                <span>Total: <strong>3-7 hari kerja</strong></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl shadow-lg p-6 text-white">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="text-lg font-bold mb-2">✍️ Sistem Otomatis & Berurutan</h3>
                        <p class="text-indigo-100 text-sm leading-relaxed">
                            Sistem akan kirim WhatsApp ke Level 1. Setelah upload & verified, <strong>otomatis lanjut</strong> ke Level 2, kemudian Level 3. Anda hanya perlu verify setiap TTD yang masuk.
                        </p>
                    </div>
                </div>
            </div>

            {{-- Signature Flow Visual - PART 1 (Level 1) --}}
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-5 border-2 border-blue-200">
                                <div class="flex items-center justify-between mb-3">
                                    <div>
                                        <span class="inline-block px-3 py-1 bg-blue-600 text-white text-xs font-bold rounded-full mb-2">TTD LEVEL 1</span>
                                ...
                                <div class="mt-3 flex items-center gap-2 text-sm text-blue-700">
                                    ...
                                    <span class="font-semibold">Akan menerima WhatsApp + link upload</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-5 border-2 border-purple-200">
                                <div class="flex items-center justify-between mb-3">
                                    <div>
                                        <span class="inline-block px-3 py-1 bg-purple-600 text-white text-xs font-bold rounded-full mb-2">TTD LEVEL 2</span>
                                ...
                                <div class="bg-white/80 backdrop-blur rounded-lg p-4 border border-purple-200">
                                    <p class="text-sm text-gray-600 italic mb-2">🔄 Otomatis setelah Level 1 verified</p>
                    ...
                    <div class="relative">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-5 border-2 border-green-200">
                                <div class="flex items-center justify-between mb-3">
                                    <div>
                                        <span class="inline-block px-3 py-1 bg-green-600 text-white text-xs font-bold rounded-full mb-2">TTD LEVEL 3 - FINAL</span>
                                ...
                                <div class="bg-white/80 backdrop-blur rounded-lg p-4 border border-green-200">
                                    <p class="text-sm text-gray-600 italic mb-2">🔄 Otomatis setelah Level 2 verified</p>
                                    <p class="text-xs text-gray-500">Final TTD → Lanjut Finalisasi</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4 group">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Level 1 - Ketua Akademik + link upload TTD</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4 group">
                            <div class="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition">
                            ...
                            <div class="flex-1">
                                <p class="text-gray-800">Pejabat buka link → <strong class="text-gray-900">Upload TTD + QR Code</strong> via web</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4 group">
                            ...
                            <div class="flex-1">
                                <p class="text-gray-800">Admin verify TTD → <strong class="text-gray-900">Auto lanjut Level 2</strong></p>
                        ...
                        <div class="flex items-start gap-4 group">
                            ...
                            <div class="flex-1">
                                <p class="text-gray-800">Level 2 verified → <strong class="text-gray-900">Auto lanjut Level 3</strong></p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4 group">
                            ...
                            <div class="flex-1">
                                <p class="text-gray-800"><strong class="text-green-600">Selesai!</strong> Download TTD → <strong class="text-gray-900">Embed ke PDF</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex-1">
                        ...
                        <ul class="space-y-1.5 text-sm text-red-800">
                            <li class="flex items-start gap-2">
                                ...
                                <span>Setiap pejabat upload <strong>2 file: TTD (PNG) + QR Code (PNG)</strong></span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-red-500 font-bold mt-0.5">•</span>
                                <span>Admin harus <strong>verify setiap TTD</strong> yang masuk</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-red-500 font-bold mt-0.5">•</span>
                                <span>Setelah semua verified → <strong>Download TTD</strong> → <strong>Embed manual ke PDF</strong></span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="text-red-500 font-bold mt-0.5">•</span>
                                <span>Link upload berlaku <strong>7 hari</strong></span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            {{-- Action Buttons --}}
            <form action="{{ route('admin.signatures.request', $document->id) }}" method="POST">
                @csrf
                <div class="flex gap-4">
                    ...
                    <button type="submit"
                            class="flex-1 px-6 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white rounded-xl font-bold transition shadow-lg hover:shadow-xl text-center flex items-center justify-center gap-2 transform hover:scale-105">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path>
                        </svg>
                        Mulai Request TTD 3 Level
                    </button>
                </div>
            </form>
        </div>
